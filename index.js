...
/* nestedFunction can access the variable internal because of closure.  Closure happens when a program gets to a certain variable that needs defining and the program needs to search outside of it's current scope.  If it can't define the variable in it's parent scope then it goes outside of that until there aren't anymore layers.  If it gets to the final layer and still isn't defined then the console will log undefined. */  
